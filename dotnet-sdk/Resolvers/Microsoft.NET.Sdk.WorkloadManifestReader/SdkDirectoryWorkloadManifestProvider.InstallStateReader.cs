                ...
                while (reader.Read())
                {
                    switch (reader.TokenType)
                    {
                        ...
                        case JsonTokenType.EndObject:
                            return installState;
                        default:
                            throw new JsonFormatException(Strings2.UnexpectedTokenAtOffset, reader.TokenType, reader.TokenStartIndex);
                    }
                }

                throw new JsonFormatException(Strings2.IncompleteDocument);
            }
