...
{
	public class GTK3NotInstalledOnWindowsSolution : Solution
	{
		public GTK3NotInstalledOnWindowsSolution(Uri url, string title)
		{
			Url = url;
			Title = title;
		}
		...
		public override async Task Implement(SharedState sharedState, CancellationToken cancelToken)
		{
			...
			var p = new ShellProcessRunner(new ShellProcessRunnerOptions(tmpExe, "/S"));
